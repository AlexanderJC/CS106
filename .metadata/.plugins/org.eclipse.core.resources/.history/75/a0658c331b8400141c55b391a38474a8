...
public class Horde {
	...
	//Create variables for the size of the horde (in individuals) and the horde's Attack Interference value.
	//These values are dealt with in the Combat class.
	private int size;
	private int AI;
	...
	/**
	 * Getter for the name of the enemy type, used when creating hordes for Combat.
	 */
	...
	/**
	 * Setter for the size of the horde.
	 * @param newSize	The desired new size for the horde.
	 */
	...
	/**
	 * Getter for Attack Interference index.
	 */
	public int getAI () {
		return this.AI;
	}
	...
	/**
	 * Setter for the Attack Interference index of the horde.
	 * @param newAI	The desired new Attack Interference index.
	 */
